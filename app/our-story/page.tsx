    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Built with Love for Grandma Glenda</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              My grandma was the best storyteller I've ever known. It was her superpower. She didn't just tell stories;
              she made you feel like you were right there with her. Whether she was making everyone laugh at a family
              dinner or offering a piece of gentle wisdom, she knew the perfect story for every moment. That's how she
              showed her love.
            </p>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              thinking,{" "}
              <em>
                "What about next year? Or in ten years? What if someone wants to hear her story but doesn't know who to
                ask?"
              </em>
            </p>

            <div className="bg-white p-8 rounded-lg my-8 border-2 border-purple-200 shadow-lg">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Creating this for her changed everything for me. It turned my grief into something meaningful. I realized
              that if this helped my family so much, it could help others, too.
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Honor Your Loved One's Story</h2>
