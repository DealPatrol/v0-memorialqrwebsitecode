...
export default function SignUpPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      console.log("[v0] Starting Google OAuth sign-up")
  ...
  const handleFacebookSignIn = async () => {
    ...
    try {
      console.log("[v0] Starting Facebook OAuth sign-up")
      ...
      <div className="w-full max-w-sm">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sign in to save and edit your memorial</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs text-center text-muted-foreground">
                Sign in to save your memorial and edit it later
              </p>
            </div>
          </CardContent>
        </Card>
