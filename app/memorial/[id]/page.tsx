        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h2 className={`text-3xl font-bold ${selectedTheme.colors.text} mb-2`}>Memorial Content</h2>
              <p className={selectedTheme.colors.text}>Explore photos, videos, stories, and messages</p>
            </div>
