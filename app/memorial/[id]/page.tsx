...
export default function MemorialPage() {
  ...
  const handleImageError = (photoId: string, imageUrl: string) => {
    console.error("[v0] Failed to load image:", imageUrl)
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-left">
                  <h1 className="text-4xl font-bold text-slate-900 mb-2">{memorial?.full_name || "Memorial"}</h1>
                  <p className="text-xl text-slate-600 mb-4">Beloved and Remembered</p>
                  ...
                  <div className="flex flex-col gap-4 mt-6">
                    ...
                    <div className="pt-2 border-t">
                      <p className="text-sm text-slate-600 mb-2">Share on social media:</p>
                      <SocialShareButtons
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Memorial Content</h2>
              <p className="text-slate-600">Explore photos, videos, stories, and messages</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-purple-600">{validPhotos.length}</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">View and share photo memories</p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-blue-600">{videos.length}</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">Share video memories</p>
                  <div className="flex gap-2">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-amber-600">{stories.length}</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">Share stories and memories</p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">Leave condolences and tributes</p>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-sm text-slate-600 mb-3">Life milestones and events</p>
              ...
              <Card className="hover:shadow-lg transition-shadow bg-gradient-to-br from-purple-50 to-blue-50">
                ...
                <CardContent>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="pt-2 border-t text-xs text-slate-500">Join others in honoring this memorial</div>
                  </div>
                </CardContent>
              </Card>
            </div>
